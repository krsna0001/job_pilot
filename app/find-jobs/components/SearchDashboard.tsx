        ...
        <div className="flex flex-col md:flex-row items-end gap-4">
          ...
          <div className="w-full md:w-auto flex items-center gap-2">
            <button 
              ...
              disabled={isSyncing}
              className={`w-full md:w-auto inline-flex items-center justify-center gap-2 rounded-xl px-5 py-2.5 text-sm font-semibold transition shadow-sm ${
                isSyncing 
            ...
            >
              {isSyncing ? (
                ...
                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h.582m15.356 2a8 8 0 11-2.18-5.361" />
                </svg>
              )}
